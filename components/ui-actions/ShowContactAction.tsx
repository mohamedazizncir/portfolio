...
const LINK_CLASS =
  "inline-flex items-center gap-1.5 rounded-full border border-border bg-surface px-4 py-2 text-base text-foreground transition-colors hover:border-accent hover:text-accent focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent motion-reduce:transition-none";
...
export function ShowContactAction({ action }: Props) {
  ...
  return (
    <div className="rounded-xl border border-border border-l-2 border-l-accent bg-surface px-5 py-4 text-base">
      <p className="font-mono text-sm uppercase tracking-wide text-accent">Contact</p>
